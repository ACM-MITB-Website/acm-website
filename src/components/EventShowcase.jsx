                    ...
                    {events.map((event, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <button className="mt-8 px-6 py-2 border border-white/20 rounded-full text-sm hover:bg-white/10 hover:border-acm-teal transition-all group flex items-center gap-2 text-white">
                                    EXPLORE
                                    <div className={`w-2 h-2 rounded-full ${event.status === 'upcoming' ? 'bg-yellow-400 animate-pulse' : 'bg-green-500'}`}></div>
                                </button>
                            </motion.div>
                        </div>
                    ))}
