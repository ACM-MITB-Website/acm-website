...
const TiltCard = ({ chapter }) => {
    ...
    return (
        <motion.a
            ...
            className="relative w-full aspect-square rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center group overflow-hidden backdrop-blur-sm hover:border-white/30 transition-colors"
        >
