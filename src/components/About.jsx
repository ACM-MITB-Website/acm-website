...
const Card = ({ icon: Icon, title, description, delay }) => {
    return (
        ...
        >
            ...
            >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-zinc-800 to-black flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-white/5">
...
const About = () => {
    ...
    return (
        <section ref={containerRef} className="relative py-32 min-h-screen flex items-center z-10 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative pointer-events-none">
                <motion.div
...
const About = () => {
    ...
    const [stories] = React.useState([
        { id: 1, title: 'Community First', description: 'Building a strong network of like-minded individuals passionate about technology and innovation.', iconName: 'Users' },
        { id: 2, title: 'Learn & Grow', description: 'Providing resources, workshops, and mentorship to help students master the latest technologies.', iconName: 'Lightbulb' },
        { id: 3, title: 'Industry Ready', description: 'Organizing hackathons and projects that mimic real-world challenges to prepare you for your career.', iconName: 'Target' }
    ]);

    /* Database fetching removed as per request */
